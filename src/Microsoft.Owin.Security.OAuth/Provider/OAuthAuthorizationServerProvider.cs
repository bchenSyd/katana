...
namespace Microsoft.Owin.Security.OAuth
{
    ...
    /*     OAuthOptions = new OAuthAuthorizationServerOptions
             {
                 ...
                 Provider = new ApplicationOAuthProvider(PublicClientId),                                       
                                     ...
                                     //                         //override GrantResourceOwnerCredentials, TokenEndpoint, ValidateClientAuthentication etc
                                     // )
    ...
    /// 
    /// IOAuthAuthorizationServerProvider  OAuthAuthorizationServerOptions:: Provider { get; set; } 
    /// public static void UseOAuthBearerTokens(this IAppBuilder app, OAuthAuthorizationServerOptions options);
    /// </summary>
    /// bchen: authorization server provider --> use token provider to create token;
